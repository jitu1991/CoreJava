...
public class Card 
{
	...
	public boolean swipeIn(Station _startPoint)
	{
		...
		{
			System.out.println("MSCS::  You are not allowed to travel,Minimum balance should be 5.5 rupees :)");
			return false;
	...
	public void recharge(Float amount)
	{
		...
		System.out.println("MSCS::  Your total balance is now "+initBalance +"Rupees ");
	...
	public boolean swipeOut(Station _endPoint)
	{
		...
		else
		{
			...
			System.out.println("MSCS::  Thank you for using delhi metro ,your current balance is"+initBalance );
			return true;
